...
namespace cufftdx {
    ...
    namespace detail {
        ...
        struct check_operators<Operator> {
            static constexpr bool value = commondx::detail::is_operator_expression<Operator>::value;
        };

        template<class HeadOperators, class... TailOperators>
        struct check_operators<HeadOperators, TailOperators...> {
            static constexpr bool value =
                 commondx::detail::is_operator_expression<HeadOperators>::value && check_operators<TailOperators...>::value;
        };
        ...
        struct remove_operators<Description, NewOperator> {
            static constexpr fft_operator operator_type   = commondx::detail::get_operator_type<cufftdx::fft_operator, NewOperator>::value;
            static constexpr bool         can_be_replaced = !(commondx::detail::is_operator<fft_operator, fft_operator::block, NewOperator>::value ||
                                                      commondx::detail::is_operator<fft_operator, fft_operator::thread, NewOperator>::value);
            using type = CUFFTDX_STD::conditional_t<can_be_replaced, commondx::detail::filter_t<Description, fft_operator, operator_type>, Description>;
        };
        ...
        struct remove_operators<Description, HeadNewOperators, TailNewOperators...> {
            static constexpr fft_operator operator_type = commondx::detail::get_operator_type<cufftdx::fft_operator, HeadNewOperators>::value;
            static constexpr bool can_be_replaced       = !(commondx::detail::is_operator<fft_operator, fft_operator::block, HeadNewOperators>::value ||
                                                      commondx::detail::is_operator<fft_operator, fft_operator::thread, HeadNewOperators>::value);
            using filtered_type                         = commondx::detail::filter_t<Description, fft_operator,operator_type>;
            using type                                  = CUFFTDX_STD::conditional_t<can_be_replaced,
                                                   remove_operators_t<filtered_type, TailNewOperators...>,
                                                   remove_operators_t<Description, TailNewOperators...>>;
        };
        ...
        struct add_operators<Description, OriginalDescription, Force, NewOperator> {
            ...
            static constexpr bool         can_be_added =
                (had_operator || Force) && !(commondx::detail::is_operator<fft_operator,fft_operator::block, NewOperator>::value ||
                                             commondx::detail::is_operator<fft_operator,fft_operator::thread, NewOperator>::value);
            using type = CUFFTDX_STD::
                conditional_t<can_be_added, commondx::detail::concatenate_description_t<NewOperator, Description>, Description>;
        };
        ...
        struct add_operators<Description, OriginalDescription, Force, HeadNewOperators, TailNewOperators...> {
            ...
            static constexpr bool can_be_added =
                (had_operator || Force) && !(commondx::detail::is_operator<fft_operator,fft_operator::block, HeadNewOperators>::value ||
                                             commondx::detail::is_operator<fft_operator,fft_operator::thread, HeadNewOperators>::value);
            using concatenated_type = commondx::detail::concatenate_description_t<HeadNewOperators, Description>;
            using type = CUFFTDX_STD::conditional_t<can_be_added,
                                          add_operators_t<concatenated_type, OriginalDescription, Force, TailNewOperators...>,
                                          add_operators_t<Description, OriginalDescription, Force, TailNewOperators...>>;
        };
        ...
        struct replace_force {
            ...
            using new_fft_description = CUFFTDX_STD::conditional_t<
                is_fft_execution<replaced_description>::value,
                replaced_description,
                typename detail::convert_to_fft_description<replaced_description>::type>;
