...
$(BIN)fourier.o: $(DIR)fourier.cpp $(DIR)golay.h
	$(CC) -Wall -Wextra -O3 -g -c $(DIR)fourier.cpp -o $(BIN)fourier.o -L./lib/fftw-3.3.10/.libs -l:libfftw3.a
...
$(BIN)generate_orderly: $(SRC)generate_orderly.cpp $(DIR)golay.h $(BIN)array.o $(BIN)fourier.o $(BIN)orderly_equivalence.o
	$(CC) -Wall -g -O3 $(SRC)generate_orderly.cpp $(BIN)orderly_equivalence.o $(BIN)array.o $(BIN)fourier.o -o $(BIN)generate_orderly -fopenmp -L./lib/fftw-3.3.10/.libs -l:libfftw3.a -lm 
...
$(BIN)uncompression: $(SRC)uncompression.cpp $(BIN)array.o $(BIN)equivalence.o 
	$(CC) -Wall -g -O3 $(SRC)uncompression.cpp $(BIN)equivalence.o $(BIN)fourier.o $(BIN)array.o -o $(BIN)uncompression -L./lib/fftw-3.3.10/.libs -l:libfftw3.a 
